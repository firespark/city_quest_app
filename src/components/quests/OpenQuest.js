    	...
    	<View style={gStyle.mb20}>
			...
			>
			    ...
			    <Image 
	                ...
	                style={gStyleQuests.questOpenImage}
	            />
			    <View style={gStyle.ml15}>
			        <Text selectable style={gStyleQuests.questOpenTitle}>{quest.quest_title}</Text>
			        <Text selectable style={gStyleQuests.questOpenCity}>{quest.city}</Text>
			        <Text style={gStyle.text}>Уровень {quest.step} из {quest.levels}</Text>
